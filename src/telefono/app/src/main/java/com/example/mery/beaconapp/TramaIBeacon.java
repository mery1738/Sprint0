...
// ------------------------------------------------------------------
// TramaIBeacon.java
// Descripción: Extrae y organiza los campos de una trama iBeacon BLE.
// ------------------------------------------------------------------
...
// --------------------------------------------------------------
    // Getters — Devuelven los distintos campos de la trama
    // Diseño: -> getX() -> bytes[] / byte
// --------------------------------------------------------------
...
// --------------------------------------------------------------
    // TramaIBeacon()
    // Descripción: Constructor que separa los bytes de la trama en sus campos.
    // Diseño: bytes[] -> TramaIBeacon() -> objeto
    // Parámetros: bytes : trama BLE completa
// --------------------------------------------------------------
