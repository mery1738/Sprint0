...
private:
  ...
  const char * nombreEmisora; // [char] : lista de caracteres
  const uint16_t fabricanteID; // N : número natural
  const int8_t txPower; // Z : número entero
...
public:
  ...
  using CallbackConexionTerminada = void ( uint16_t connHandle, uint8_t reason);
   ...
   // --------------------------------------------------------
   // Constructor : Inicializa la configuración sin encender la emisora. 
   // [char] : nombreEmisora_ , N : fabricanteID_ , Z : txPower_ -> constructor() ->
   // --------------------------------------------------------
  ...
  // --------------------------------------------------------
  // Encender emisora BLE (solo anuncios); solo inicializa y detiene anuncios previos.
  // --------------------------------------------------------
  ...
  // --------------------------------------------------------
  // Encender la emisora BLE con callbacks; inicializa e instala manejadores de conexión/desconexión.
  // callback : cbce , callback : cbct -> encenderEmisora() ->
  // --------------------------------------------------------
  ...
  // --------------------------------------------------------
  // Detener el anuncio actual si está en marcha.
  // --------------------------------------------------------
  void detenerAnuncio() {
  ...
  // .........................................................
  // Comprobar si la emisora está anunciando.
  ...
  // .........................................................
  // Emitir anuncio en formato iBeacon.
